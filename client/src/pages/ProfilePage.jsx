...
import { FaUserCircle, FaGithub, FaLinkedin, FaBriefcase, FaCode, FaLock, FaTrashAlt } from "react-icons/fa";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-10">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm flex flex-col items-center text-center">
            <div className="w-32 h-32 bg-slate-800 rounded-full flex items-center justify-center mb-4 border-4 border-slate-950 shadow-lg relative group cursor-pointer">
